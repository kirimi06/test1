//
//  エネミーアピアランスインジケーター ver1.00
//
// author yana
//

var Imported = Imported || {};
Imported['EnemyAppearanceIndicator'] = 1.00;

/*:
 * @plugindesc ver1.00/ランダムエンカウントにおいて、敵の接近を視覚化したウィンドウを追加します。
 * @author Yana
 * 
...
(function() {
	...
	Scene_Map.prototype.checkEaiShow = function() {
		...
		if ($gameMap.encounterList().length > 0 && !$gameMap.isEventRunning()){
